...
from spider_jk2103.settings import user_agent_list,PROXY_LIST
...
class ProxyDownloaderMiddleware:
    _proxy = ('y272.kdlfps.com', '18866')

    def process_request(self, request, spider):

        # 用户名密码认证
        username = "f2979446927"
        password = "aczfgzu4"
...
# class SpiderJk2103SpiderMiddleware:
...
# class SpiderJk2103DownloaderMiddleware:
#     # Not all methods need to be defined. If a method is not defined,
